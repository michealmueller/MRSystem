...
<div class="well well-primary">
    <form role="form" action="route.php" method="post" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <input id="password" name="password" class="form-control" type="text" tabindex="2" maxlength="32">
        </div>
        ...
        <input type="hidden" id="reg-form" name="formtype" value="manager-reg-form">
    </form>
</div>
</body>
</html>
